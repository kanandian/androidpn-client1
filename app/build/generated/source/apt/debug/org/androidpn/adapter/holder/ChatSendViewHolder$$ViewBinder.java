...
public class ChatSendViewHolder$$ViewBinder<T extends org.androidpn.adapter.holder.ChatSendViewHolder> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131230962, "field 'chatItemFail'");
    target.chatItemFail = finder.castView(view, 2131230962, "field 'chatItemFail'");
    view = finder.findRequiredView(source, 2131230966, "field 'chatItemProgress'");
    target.chatItemProgress = finder.castView(view, 2131230966, "field 'chatItemProgress'");
